...
#define CONTEXT_SLOT     BYTE
    ...
    //         LDAA
    //*****************************************************************************
    // This entire section uses in total 1B + 2B + 1B + 32B + 4B + 33MB = 33MB
    // of memory.
    //
    ...
    // Keep internal state of the sign process. This variable uses 33MB.
    ldaa_sign_state_i_t sign_states_tpm[1/*MAX_LDAA_C*/];
